...
function App() {
    ...
    const handleOpenDeleteClassDialog = (classGroup) => {
        setClassToDelete(classGroup);
    ...
    const addClassMutation = useMutation({
        ...
        onSuccess: (response, variables) => {
            ...
            textToast("Class created");
            handleCloseAddClassDialog();
        },
        onError: () => {
            textToast("Failed to create class");
        },
    });
    ...
    const handleCreateClass = () => {
        ...
        if (className === "") {
            textToast("Class name is required");
            return;
        }
    ...
    return (
        <>
            ...
            <Dialog open={showAddClassDialog} onClose={handleCloseAddClassDialog}>
                ...
                <DialogActions>
                    <Button onClick={handleCloseAddClassDialog} variant="outlined">
                        Cancel
                    </Button>
                    <Button onClick={handleCreateClass} variant="contained" disabled={addClassMutation.isPending}>
                        {addClassMutation.isPending ? "Creating..." : "Create"}
                    </Button>
                </DialogActions>
            </Dialog>
            ...
            <Dialog open={showDeleteClassDialog} onClose={handleCloseDeleteClassDialog}>
                <DialogTitle>Delete Class</DialogTitle>
                <DialogContent>
                    <DialogContentText>
                        Are you sure you want to delete class {classToDelete?.name ? `"${classToDelete.name}"` : ""}? This action cannot be undone.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <Button onClick={handleCloseDeleteClassDialog} variant="outlined">
                        Cancel
                    </Button>
